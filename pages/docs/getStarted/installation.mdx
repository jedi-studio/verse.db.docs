...
## Creating a database
our recommanded options is to use our `npm create verse.db@latest{:bash}` to create a new database conenction but in [`installing database without create function{:md}`](#) you can do everything manual if you want
