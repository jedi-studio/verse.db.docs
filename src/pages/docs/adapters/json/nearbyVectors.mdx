...
description: The nearbyVectors method in the JSON adapter for Verse.db allows you to search for vectors that are nearby a specified point within a given radius.
adapter: JSON
---
